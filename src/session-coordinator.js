...
`;
  ...
  displayInstructions(instructions, sessionId, task) {
    ...
    console.log(`FILE COORDINATION PROTOCOL (MANDATORY - from house rules at ${houseRulesPath}):`);
    console.log(`Shared lock directory: ${coordPath}`);
    console.log(``);
    console.log(`BEFORE editing ANY files, create a declaration file:`);
    console.log(`File: local_deploy/.file-coordination/active-edits/<your-agent-name>-${sessionId}.json`);
    console.log(``);
    console.log(`Example declaration:`);
    console.log(`{`);
    console.log(`  "agent": "claude",`);
    console.log(`  "session": "${sessionId}",`);
    console.log(`  "files": ["src/app.js", "README.md"],`);
    console.log(`  "operation": "edit",`);
    console.log(`  "reason": "${task}",`);
    console.log(`  "declaredAt": "${new Date().toISOString()}",`);
    console.log(`  "estimatedDuration": 300`);
    console.log(`}`);
    console.log(``);
    console.log(`Steps:`);
    console.log(`1. Check for conflicts: ls local_deploy/.file-coordination/active-edits/`);
    console.log(`2. Create YOUR declaration file with the files you plan to edit`);
    console.log(`3. Make your changes ONLY to files you declared`);
    console.log(`4. Write commit message to: .devops-commit-${sessionId}.msg`);
    console.log(`5. Delete your declaration after committing`);
    console.log(``);
    console.log(`The DevOps agent will automatically commit and push changes.`);
    console.log(``);
    console.log(`Remember: ALWAYS check house rules first, declare files, then WAIT for user instructions!`);
    console.log();
